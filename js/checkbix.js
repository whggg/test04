	...
	*/
	var buildMarkup = function () {
		...
		for (var i = 0; i < checkboxes.length; i++) {
			...
			checkboxes[i].insertAdjacentHTML('afterend', '<label aria-label="'+arialabel+'" role="checkbox" for="'+checkboxes[i].id+'" class="'+settings.initClass+'"><span class="'+size+'"></span>'+'</label>');
		}
